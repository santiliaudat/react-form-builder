...
var ReactForm = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRenderSubmit", function () {
      var _this$props = _this.props,
          _this$props$action_na = _this$props.action_name,
          action_name = _this$props$action_na === void 0 ? 'Submit' : _this$props$action_na,
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRenderBack", function () {
  ...
  _createClass(ReactForm, [{
    ...
    value: function render() {
      ...
      var fontFamily = this.props.fontFamily ? this.props.fontFamily : "Roboto";
      var fontSize = this.props.fontSize ? this.props.fontSize : "12px";
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "react-form-builder-form ".concat(this.props.className)
        ...
        className: "btn-toolbar ".concat(this.props.classNameToolbar)
